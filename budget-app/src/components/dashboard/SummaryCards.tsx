...
export default function SummaryCards({ summary }: { summary: MonthlySummary }) {
  const cards = [
    { label: '이번 달 수입', amount: summary.income, accent: 'text-blue-600 dark:text-blue-400' },
    {
      label: '이번 달 총지출',
    ...
    { label: '이번 달 순잔액', amount: summary.netBalance, accent: 'text-gray-900 dark:text-gray-100' },
  ];
